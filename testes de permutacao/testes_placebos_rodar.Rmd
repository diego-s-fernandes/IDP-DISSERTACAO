...
placebos_rodar <- placebos_rodar %>%
  ...
  filter(ano %in% c(2000:2018), regio %in% c(23,155, 194, 195,35, 91, 66, 82, 30, 132, 160, 188, 177, 7, 165, 170)) %>% 
...
dataprep.out <-
              dataprep(foo = as.data.frame(placebos_rodar),
                      ...
                      special.predictors =list( list("final_consumption_expenditure_annual_growth",seq(2003,2011,2),c("mean"))),
                       ...
                       controls.identifier = c(1,3:9,11:16),
...
mspe_plot + labs(x = "Post-/Pre-RMSPE")
save_plot("placemais.png", fig = ggplot2::last_plot(), width = 15, height = 10,
